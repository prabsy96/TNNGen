...
class Test_TNN_func:
    ...
    def mkTest_less_equal(self):
        
        m = Module('test_less_equal')
        lq = self.tnn.mkLessequal()
...
def mkTest_Stdp_case_gen():
    ...
    stdp_case = self.tnn.mkStdp_case_gen()
...
def mkTest_Fsm_simple():
    ...
    fsm_simple = self.tnn.mkFsm_simple()
...
def mkTest_Fsm_synapse():
    ...
    synapse = self.tnn.mkFsm_synapse()
...
def mkTest_Pac():
    m = Module('test_pac')
    pac = self.tnn.mkPac(ip_size = 4, thres = 13)
...
def mkTest_Neuronbody():
    ...
    nb = self.tnn.mkNeuronbody(ip_size = 4, thres = 13)
...
def mkTest_NeuronRNL():
    ...
    ip_size_def = 4
    rnl = self.tnn.mkNeuronRNL(ip_size = 4, thres = 11)
