...
# parse command line aarguments
	...
	if top_lvl_mdl == 'column':
		...
		gen_verilog(module = obj, path = 'out_rtl', filename = 'column.v', print_v = True)
		...
		if top_lvl_mdl == 'less_equal':
			...
			gen_verilog(module = obj, path = 'out_rtl', filename = 'less_equal.v', print_v = False)
			...
			gen_verilog(module = obj, path = 'out_rtl', filename = 'pulse2edge.v', print_v = False)
			...
			gen_verilog(module = obj, path = 'out_rtl', filename = 'edge2pulse.v', print_v = False)
			...
			gen_verilog(module = obj, path = 'out_rtl', filename = 'adder.v', print_v = False)
			...
			gen_verilog(module = obj, path = 'out_rtl', filename = 'incdec.v', print_v = False)
			...
			if isinstance(q, int):
				raise TypeError('Provide a valid number')
			...
			gen_verilog(module = obj, path = 'out_rtl', filename = 'wta.v', print_v = False)
			...
			gen_verilog(module = obj, path = 'out_rtl', filename = 'flogic.v', print_v = False)
			...
			gen_verilog(module = obj, path = 'out_rtl', filename = 'stdp_case_gen.v', print_v = False)
			...
			gen_verilog(module = obj, path = 'out_rtl', filename = 'fsm_simple.v', print_v = False)
			...
			gen_verilog(module = obj, path = 'out_rtl', filename = 'fsm_synapse.v', print_v = False)
			...
			gen_verilog(module = obj, path = 'out_rtl', filename = 'stdp.v', print_v = False)
			...
			gen_verilog(module = obj, path = 'out_rtl', filename = 'pac.v', print_v = False)
			...
			gen_verilog(module = obj, path = 'out_rtl', filename = 'neuron_body.v', print_v = False)
			...
			gen_verilog(module = obj, path = 'out_rtl', filename = 'neuron_rnl.v', print_v = False)
