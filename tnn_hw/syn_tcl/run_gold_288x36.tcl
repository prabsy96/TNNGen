...
set _OUTPUTS_PATH /afs/ece.cmu.edu/usr/pvellais/Private/RA_work/7nm_optimizations/final_set/unoptimized_new_pac/outputs228x36
set _REPORTS_PATH /afs/ece.cmu.edu/usr/pvellais/Private/RA_work/7nm_optimizations/final_set/unoptimized_new_pac/reports228x36
set _LOG_PATH logs
...
####################################################################
 ...
 read_hdl -language sv "adder.sv   edge2pulse.sv incdec.sv neuron_body.sv pac.sv stdp_case_gen.sv  wta.sv column288x36.sv  flogic.sv fsm_simple.sv  less_equal.sv  neuron_rnl_ptt.sv  pulse2edge.sv  stdp.sv register.sv  fsm_weight_update.sv fsm_output.sv fsm_synapse.sv chip.sv"
