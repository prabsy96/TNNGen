...
set _OUTPUTS_PATH ./unoptimized_diff/${DESIGN}_270x25outputs
set _REPORTS_PATH ./unoptimized_diff/${DESIGN}_270x25reports
...
####################################################################
 ...
 read_hdl -language sv "adder.sv  edge2pulse.sv incdec.sv neuron_body.sv pac.sv stdp_case_gen.sv  wta.sv column270x25.sv  flogic.sv fsm_simple.sv  less_equal.sv  neuron_rnl_ptt.sv  pulse2edge.sv  stdp.sv register.sv  fsm_weight_update.sv fsm_output.sv fsm_synapse.sv "
